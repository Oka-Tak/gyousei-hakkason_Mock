...
const FIELD_OPTIONS = [
  ...
  { value: '教育', label: '教育・子育て' },
  { value: '医療', label: '医療・福祉' },
  { value: '防災', label: '防災・安全' },
  { value: '環境', label: '環境・エネルギー' },
  { value: '産業', label: '産業・雇用' },
];
...
const HomePage: React.FC = () => {
  ...
  const handleSearch = useCallback(() => {
    ...
    if (selectedField) searchTerms.push(selectedField);
    if (keyword.trim()) searchTerms.push(keyword.trim());
    ...
    router.push(`/graph?search=${encodeURIComponent(query)}`);
  }, [selectedField, keyword, router]);
    ...
    <div className="landing-page">
      ...
      <header className="header">
        <div className="container">
          ...
          <nav className="nav">
            <Link href="/graph" className="cta-button">
              システムを開始
            </Link>
          </nav>
        </div>
      ...
      <section className="call-for-action">
        <div className="container">
          ...
          <div className="cta-buttons">
            <Link href="/graph" className="large-cta-button primary">
              <span>🚀</span>
              今すぐ始める
            </Link>
      ...
      <style jsx>{`
        ...
        .search-button:hover {
          ...
          box-shadow: 0 4px 16px rgba(7,121,107,0.3);
        }
